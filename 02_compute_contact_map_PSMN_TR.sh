...
do
	...
	do
		...
		do
			...
			tmpDir=_tmp_rc_${replicaDir}_TR
			if [[ -d ${tmpDir} ]];
			then
			    echo "${tmpDir} exists!"
			    continue
			...
			then
				...
				for r in replicaDir ;
				do
				    ls -1 /home/aabdulla/3D/March2024/LatticePoly/LatticePoly/data/*/${replicaDir}/*_${t}_pos.res 2> /dev/null >> DATA_FILES_INPUT.txt
